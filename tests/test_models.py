...
@pytest.mark.parametrize("id, friendly_name", [
...
def test_instrument_metadata_type(id, friendly_name):
    if id == 'invalid_id':
        ...
        instrument_metadata_type = conversion_calculator.models.InstrumentMetadataType(id=id)
...
@pytest.mark.parametrize("column_name, column_name_components", [
    ( "cvlt_form", ["cvlt", "form"]),
