...
ravlt_imfr_column_order = {"ravlt": 0, "havlt": 1, "cvlt": 2}
ravlt_imfr_lookup_table = np.array(
    [
        [0, 0, 0],
        [1, 2, 0],
        [2, 3, 1],
...
ravlt_imfr = CrossWalk(
    instrument=instrument_ravlt,
    instrument_item=instrument_item_imfr,
    column_order=ravlt_imfr_column_order,
    lookup_table=ravlt_imfr_lookup_table,
)

ravlt_imfr_c = CrossWalk(
    instrument=instrument_ravlt,
    instrument_item=instrument_item_imfr,
