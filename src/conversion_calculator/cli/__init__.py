...
@app.command()
def convert(input_file: str, output_file: str, force: Annotated[bool, "--force", "-f"] = False):
    ...
    with open(input_file, "r") as f:
        try:
            converted_data = conversion_calculator.lib.convert_spreadsheet(conversion_calculator.lib.parse_input_csv(f))
